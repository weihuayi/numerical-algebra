...
class LuAlgorithmPage(QWidget):
    ...
    def widget_setting(self):
        ...
        class WidgetInner(QTabWidget):
            def __init__(self, dimation):
                ...
                self.tablewidget.append(QTableWidget(1, 1))
                self.tablewidget[0].setColumnCount(dimation)
                self.tablewidget[0].setRowCount(dimation)
                self.tablewidget[0].resizeColumnsToContents()
                self.layout[0].addWidget(self.tablewidget[0], 0, 0, 1, 1)
                # tablewidget 1 := origin matrix P in lu_0
                self.tablewidget.append(QTableWidget(1, 1))
                self.tablewidget[1].setColumnCount(dimation)
                self.tablewidget[1].setRowCount(dimation)
                ...
                self.tablewidget.append(QTableWidget(1, 1))
                self.tablewidget[2].setColumnCount(dimation)
                self.tablewidget[2].setRowCount(dimation)
                self.tablewidget[2].resizeColumnsToContents()
                self.layout[0].addWidget(self.tablewidget[2], 1, 0, 1, 1)
                # tablewidget 3 := origin matrix U in lu_0
                self.tablewidget.append(QTableWidget(1, 1))
                self.tablewidget[3].setColumnCount(dimation)
                self.tablewidget[3].setRowCount(dimation)
                self.tablewidget[3].resizeColumnsToContents()
                ...
                self.tablewidget.append(QTableWidget(1, 1))
                self.tablewidget[4].setColumnCount(dimation)
                self.tablewidget[4].setRowCount(dimation)
                self.tablewidget[4].resizeColumnsToContents()
                self.layout[1].addWidget(self.tablewidget[4], 0, 0, 1, 1)
                # tablewidget 6 := origin matrix P in lu_1
                self.tablewidget.append(QTableWidget(1, 1))
                self.tablewidget[5].setColumnCount(dimation)
                self.tablewidget[5].setRowCount(dimation)
                self.tablewidget[5].resizeColumnsToContents()
                self.layout[1].addWidget(self.tablewidget[5], 0, 1, 1, 1)
                # tablewidget 7 := origin matrix L in lu_1
                self.tablewidget.append(QTableWidget(1, 1))
                self.tablewidget[6].setColumnCount(dimation)
                self.tablewidget[6].setRowCount(dimation)
                self.tablewidget[6].resizeColumnsToContents()
                self.layout[1].addWidget(self.tablewidget[6], 1, 0, 1, 1)
                # tablewidget 8 := origin matrix U in lu_1
                self.tablewidget.append(QTableWidget(1, 1))
                self.tablewidget[7].setColumnCount(dimation)
                self.tablewidget[7].setRowCount(dimation)
                self.tablewidget[7].resizeColumnsToContents()
                ...
                self.tablewidget.append(QTableWidget(1, 1))
                self.tablewidget[8].setColumnCount(dimation)
                self.tablewidget[8].setRowCount(dimation)
                self.tablewidget[8].resizeColumnsToContents()
                self.layout[2].addWidget(self.tablewidget[8], 0, 0, 1, 1)
                # tablewidget 10 := origin matrix P in lu_2
                self.tablewidget.append(QTableWidget(1, 1))
                self.tablewidget[9].setColumnCount(dimation)
                self.tablewidget[9].setRowCount(dimation)
                self.tablewidget[9].resizeColumnsToContents()
                self.layout[2].addWidget(self.tablewidget[9], 0, 1, 1, 1)
                # tablewidget 11 := origin matrix L in lu_2
                self.tablewidget.append(QTableWidget(1, 1))
                self.tablewidget[10].setColumnCount(dimation)
                self.tablewidget[10].setRowCount(dimation)
                self.tablewidget[10].resizeColumnsToContents()
                self.layout[2].addWidget(self.tablewidget[10], 1, 0, 1, 1)
                # tablewidget 12 := origin matrix U in lu_2
                self.tablewidget.append(QTableWidget(1, 1))
                self.tablewidget[11].setColumnCount(dimation)
                self.tablewidget[11].setRowCount(dimation)
                self.tablewidget[11].resizeColumnsToContents()
    ...
    def matrix_calulate(self):
        ...
        self.table_write(dimation, table=self.tabwidget[0].tablewidget[1], matrix=P, decimal_digits='%.0f')
